...
"""Utility for S3 endpoints."""
from collections import namedtuple

Endpoint = Endpoint = namedtuple('endpoint', ['name', 'host', 'zone'])
...
def known_region(region):
    """Return true if this is a know region."""
    return region in region_to_endpoint


def get_endpoint(region):
    """Get the S3 website hosting end point for this region."""
